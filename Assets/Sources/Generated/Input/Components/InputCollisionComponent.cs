...
public partial class InputEntity {
    ...
    public void AddCollision(Entitas.Unity.EntityLink newSelf, Entitas.Unity.EntityLink newOther) {
    ...
    public void ReplaceCollision(Entitas.Unity.EntityLink newSelf, Entitas.Unity.EntityLink newOther) {
        var index = InputComponentsLookup.Collision;
        var component = (CollisionComponent)CreateComponent(index, typeof(CollisionComponent));
        component.Self = newSelf;
        component.Other = newOther;
