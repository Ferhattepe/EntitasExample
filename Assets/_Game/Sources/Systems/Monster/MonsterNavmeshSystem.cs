...
{
    public class MonsterAnimationSystem : IExecuteSystem, IInitializeSystem
    {
        private readonly IGroup<GameEntity> _monsters;

        public MonsterAnimationSystem(Contexts contexts)
        {
            _monsters = contexts.game.GetGroup(GameMatcher.AllOf(GameMatcher.Monster, GameMatcher.Animation, GameMatcher.MovementDirection));
        }
